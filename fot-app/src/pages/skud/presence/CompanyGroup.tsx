...
export const CompanyGroup: FC<ICompanyGroupProps> = ({
  company,
  isExpanded,
  onToggle,
  forceExpanded = false,
  ...
  const isClickable = !forceExpanded && company.online_count > 0;

  return (
    <div className={styles.company}>
      {forceExpanded ? (
        <div className={`${styles.companyHeader} ${styles.companyHeaderOpen}`}>
      ...
      {expanded && company.employees.length > 0 && (
