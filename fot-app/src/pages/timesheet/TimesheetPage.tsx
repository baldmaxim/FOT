        ...
        <Suspense fallback={null}>
          <TimesheetCorrectionModal
            ...
            allowedStatuses={
              ...
              // Но при редактировании уже существующей корректировки (is_correction=true)
              // разрешаем менять статус на любой (включая смену Работы→Удалёнка/Отпуск).
              modalMode !== 'object' && modalEntry?.status === 'work' && !modalEntry?.is_correction
                ? ['manual']
                : undefined
            }
            initialStatus={
