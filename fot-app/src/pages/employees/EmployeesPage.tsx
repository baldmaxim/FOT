            ...
            filteredEmployees.map(emp => (
              ...
              >
                <div
                  ...
                  onClick={e => toggleEmpSelection(emp.id, e)}
                >
                ...
                {canEdit && emp.employment_status !== 'fired' && (
                  <div className="ep-emp-actions">
                    <button className="ep-action-btn dismiss" onClick={e => handleFire(emp, e)}>
                      Уволить
                    </button>
                    <button
                      className="ep-action-btn move"
                      onClick={e => { e.stopPropagation(); setMoveEmpId(emp.id); setMoveDeptValue(''); }}
                    >
                      Переместить
                    </button>
                  </div>
                ...
                {emp.employment_status === 'fired' && (
                  <div className="ep-emp-actions">
                    <button className="ep-action-btn move" onClick={e => handleRehire(emp, e)}>
                      Восстановить
                    </button>
                  </div>
                )}
