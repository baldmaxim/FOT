              ...
              <div className={styles.modal}>
                ...
                <div className={styles.form}>
                  ...
                  <section className={styles.formSection}>
                    ...
                    <label title="Сколько произвольных непраздничных суббот в месяц сотрудник обязан отработать. Слот закрывает и праздник, выпавший на будний рабочий день графика (например 12 июня). 0 — нет требования. Недобор по итогам месяца считается прогулами.">
                      Субботы в месяц, 0–5
                      <NumberInput
                        min={0}
                        max={5}
