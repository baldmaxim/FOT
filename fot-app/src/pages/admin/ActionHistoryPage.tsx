...
const ACTION_GROUPS: Record<string, string[]> = {
  ...
  'Пользователи': ['USER_APPROVED', 'USER_REJECTED', 'USER_DELETED', 'EMAIL_CONFIRMED', 'POSITION_CHANGED', 'ROLE_CHANGED', 'NAME_CHANGED', 'USER_DEPARTMENT_ACCESS_CHANGED', 'CHAT_INBOUND_MODE_CHANGED', 'ORG_ASSIGNED', 'BLACKLIST_ADDED', 'BLACKLIST_REMOVED', 'BLACKLIST_ENFORCED', 'BLACKLIST_BLOCKED_ATTEMPT'],
