...
const navGroups: INavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'contractor-approvals', path: '/admin/contractor-approvals', label: 'Подрядчики', icon: ClipboardCheckIcon, requiredPage: ['/admin/contractor-approvals', '/admin/contractor-approvals/submissions'] },
