...
export const navGroups: INavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'leave-requests', path: '/leave-requests', label: 'Заявления', icon: ClipboardCheckIcon, requiredPage: ['/leave-requests', '/salary-raise-review', '/leave-vacations', '/leave-dismissals', '/testing-review'] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'system-hub', path: '/admin/system', label: 'Система', icon: ShieldIcon, requiredPage: ['/admin/users', '/admin/roles', '/admin/audit', '/admin/action-history', '/admin/settings', '/admin/data-api', '/admin/checks'], systemAdminOnly: true },
    ]
  }
];
