...
import adminChecksRoutes from './routes/admin-checks.routes.js';
...
import weekendApprovalsRoutes from './routes/weekend-approvals.routes.js';
...
import mtsBusinessRoutes from './routes/mts-business.routes.js';
import employeeSimRoutes from './routes/employee-sim.routes.js';
import phonebookRoutes from './routes/phonebook.routes.js';
...
app.use('/api/admin/checks', adminChecksRoutes);
...
app.use('/api/mts-business', mtsBusinessRoutes);
