...
export const AUDIT_ACTIONS = {
  ...
  BLACKLIST_ENFORCED: 'BLACKLIST_ENFORCED',
  BLACKLIST_BLOCKED_ATTEMPT: 'BLACKLIST_BLOCKED_ATTEMPT',
  // Служебные записки к записи ЧС (миграция 274)
  BLACKLIST_MEMO_ADDED: 'BLACKLIST_MEMO_ADDED',
  BLACKLIST_MEMO_REMOVED: 'BLACKLIST_MEMO_REMOVED',
  ...
  EXPORT_EMPLOYEES_VIEW: 'EXPORT_EMPLOYEES_VIEW',
  UPDATE_STAFF_COMMENT: 'UPDATE_STAFF_COMMENT',
  CREATE_EMPLOYEE: 'CREATE_EMPLOYEE',
  UPDATE_EMPLOYEE: 'UPDATE_EMPLOYEE',
  DELETE_EMPLOYEE: 'DELETE_EMPLOYEE',
  DELETE_ALL_EMPLOYEES: 'DELETE_ALL_EMPLOYEES',
  // HR-профили («Реквизиты», сканы, ЗУП)
  HR_PROFILE_CREATE: 'HR_PROFILE_CREATE',
  HR_PROFILE_UPDATE: 'HR_PROFILE_UPDATE',
  HR_PROFILE_VIEW_SENSITIVE: 'HR_PROFILE_VIEW_SENSITIVE',
  HR_FILE_UPLOAD: 'HR_FILE_UPLOAD',
  HR_FILE_VIEW: 'HR_FILE_VIEW',
  HR_FILE_DOWNLOAD: 'HR_FILE_DOWNLOAD',
  HR_FILE_DELETE: 'HR_FILE_DELETE',
  HR_OCR_RUN: 'HR_OCR_RUN',
  HR_OCR_APPLY: 'HR_OCR_APPLY',
  HR_OCR_DISMISS: 'HR_OCR_DISMISS',
  HR_ZUP_TOGGLE: 'HR_ZUP_TOGGLE',
  HR_ZUP_EXPORT: 'HR_ZUP_EXPORT',
  HR_DRAFT_COMMIT: 'HR_DRAFT_COMMIT',
  HR_ATTACH_EXISTING: 'HR_ATTACH_EXISTING',
  HR_STAGING_LINK: 'HR_STAGING_LINK',
  ...
  TIMESHEET_APPROVAL_ROSTER_REBUILT: 'TIMESHEET_APPROVAL_ROSTER_REBUILT',
  ...
  DATA_API_KEY_DELETED: 'DATA_API_KEY_DELETED',
  DATA_API_KEY_TABLES_UPDATED: 'DATA_API_KEY_TABLES_UPDATED',
  // Проверки newdb.net (РКЛ / патент)
  NEWDB_SETTINGS_UPDATED: 'NEWDB_SETTINGS_UPDATED',
  NEWDB_CHECK_RUN: 'NEWDB_CHECK_RUN',
  ...
  // Исправление опечатки в ФИО держателя из «Мониторинга» (пропуск + кадры + Sigur).
  CONTRACTOR_PASS_HOLDER_RENAMED: 'CONTRACTOR_PASS_HOLDER_RENAMED',
  // Ночная синхронизация «Срока» пропуска с фактическим сроком привязки карты в Sigur.
  CONTRACTOR_PASS_EXPIRY_SYNCED: 'CONTRACTOR_PASS_EXPIRY_SYNCED',
  ...
  MTS_BUSINESS_DETALIZATION_CLEARED: 'MTS_BUSINESS_DETALIZATION_CLEARED',
  MTS_BUSINESS_NUMBER_MAP_UPDATED: 'MTS_BUSINESS_NUMBER_MAP_UPDATED',
  MTS_BUSINESS_PHONEBOOK_HIDDEN_SET: 'MTS_BUSINESS_PHONEBOOK_HIDDEN_SET',
  ...
  MTS_BUSINESS_REFRESH_ALL_STARTED: 'MTS_BUSINESS_REFRESH_ALL_STARTED',
  MTS_BUSINESS_REFRESH_ALL_SCHEDULE_UPDATED: 'MTS_BUSINESS_REFRESH_ALL_SCHEDULE_UPDATED',
  MTS_BUSINESS_DETALIZATION_UPLOADS_CLEARED: 'MTS_BUSINESS_DETALIZATION_UPLOADS_CLEARED',
  ...
  MTS_BUSINESS_PERSONAL_DATA_SUBMITTED: 'MTS_BUSINESS_PERSONAL_DATA_SUBMITTED',
  MTS_BUSINESS_PERSONAL_DATA_DELETE_REQUESTED: 'MTS_BUSINESS_PERSONAL_DATA_DELETE_REQUESTED',
  // KPI закрытия КС-2 (объекты строительства)
  OBJECT_KPI_CONTRACT_SAVED: 'OBJECT_KPI_CONTRACT_SAVED',
  OBJECT_KPI_ADDENDUM_SAVED: 'OBJECT_KPI_ADDENDUM_SAVED',
  OBJECT_KPI_KS2_SAVED: 'OBJECT_KPI_KS2_SAVED',
  OBJECT_KPI_KS6_SAVED: 'OBJECT_KPI_KS6_SAVED',
  OBJECT_KPI_PLAN_FIXED: 'OBJECT_KPI_PLAN_FIXED',
