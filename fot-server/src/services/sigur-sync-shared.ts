 ...
 *
 * Пишутся ТОЛЬКО строки фильтра (без options.reconcile): активность отделов ремап
 * не трогает. Реконсиляция по иерархии БД из фона воскрешала строки, давно удалённые
 * в Sigur (03–04.09.2026, «дубли папок»); включать/выключать отделы имеют право
 * только синк по снимку Sigur и пользователь при сохранении фильтра.
 */
