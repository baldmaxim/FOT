...
export const DEFAULT_ACCESS_PAGE_CATALOG: PageCatalogItem[] = [
  ...
  { key: '/employee/sim',               label: 'Личный кабинет — Моя SIM',             group_code: 'mine',  group_label: 'Моё',                  surface: 'page',      supports_edit: false, sort_order: 15,  is_active: true },
  { key: '/employee/phonebook',         label: 'Личный кабинет — Телефонная книга',    group_code: 'mine',  group_label: 'Моё',                  surface: 'page',      supports_edit: false, sort_order: 16,  is_active: true },
