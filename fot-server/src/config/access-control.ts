...
export const PAGE_PATHS = {
  ...
  EMPLOYEE_TESTING: '/employee/testing',
  EMPLOYEE_OBJECTS: '/employee/objects',
  ...
  ADMIN_USERS_ACCOUNTS: '/admin/users/accounts',
...
export const DEFAULT_ACCESS_PAGE_CATALOG: PageCatalogItem[] = [
  ...
  { key: '/employee/testing',           label: 'Тестирование',                         group_code: 'lk',    group_label: 'Личный кабинет',       area: 'personal', surface: 'page',      supports_edit: true,  sort_order: 19,  is_active: true },
  ...
  { key: '/testing-review',             label: 'Тестирование (разбор)',                group_code: 'work',  group_label: 'Управление',           area: 'admin',    surface: 'page',      supports_edit: true,  sort_order: 132, is_active: true },
  ...
  // Учётки всей организации без скоупа отделов: регистрации, email, сброс пароля, ФИО,
  // удаление, привязка подрядчика к организации. Только allowlist-роли, чужие права — нет.
  { key: '/admin/users/accounts',       label: 'Система — Пользователи: учётки всей организации', group_code: 'admin', group_label: 'Администрирование', area: 'admin', surface: 'technical', supports_edit: true, sort_order: 250, is_active: true },
