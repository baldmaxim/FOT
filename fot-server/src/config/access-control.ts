...
export const DEFAULT_ACCESS_PAGE_CATALOG: PageCatalogItem[] = [
  ...
  { key: '/staff-control/hiring',       label: 'Управление кадрами — Заявки для HR',   group_code: 'work',  group_label: 'Управление',           surface: 'page',      supports_edit: false, sort_order: 105, is_active: true },
