...
export const DEFAULT_ACCESS_PAGE_CATALOG: PageCatalogItem[] = [
  ...
  { key: '/admin/contractor-approvals', label: 'Согласование подрядчиков',             group_code: 'admin', group_label: 'Администрирование',    surface: 'page',      supports_edit: true,  sort_order: 242, is_active: true },
