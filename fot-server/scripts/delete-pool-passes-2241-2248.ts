/**
 * Одноразовое удаление пропусков из общего пула подрядчика: №2241–2248
 * (чтобы последний пропуск в пуле стал 2240).
 *
 ...
 *   cd fot-server
 *   npx tsx scripts/delete-pool-passes-2241-2248.ts            # dry-run, только план
 *   npx tsx scripts/delete-pool-passes-2241-2248.ts --migrate  # применить
 */
...
const LOG = '[delete-pool-2241-2248]';
