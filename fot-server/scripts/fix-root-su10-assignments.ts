 ...
 * «(СУ-10) ООО СУ-10» у 12 сотрудников секретариата/комендантской службы.
 *
 ...
 *   - Гейнц 8781 → Секретариат-Объекты (закрытый июньский хвост 01.06–09.06:
 *     Sigur держал её в корне до перевода 10.06; из-за него она в корне
 *     в ИЮНЬСКОМ «Едином 1С»; решение HR — весь июнь в одном отделе)
 *
...
const TARGETS: ITarget[] = [
  ...
  { employeeId: 8781, name: 'Гейнц Милада Александровна', targetDeptId: SECRETARIAT_OBJ },
];
