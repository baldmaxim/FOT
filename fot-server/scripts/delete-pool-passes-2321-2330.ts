/**
 * Одноразовое удаление пропусков из общего пула подрядчика: №2321–2330
 * (чтобы последний пропуск в пуле снова стал 2320).
 *
 ...
 *   cd fot-server
 *   npx tsx scripts/delete-pool-passes-2321-2330.ts            # dry-run, только план
 *   npx tsx scripts/delete-pool-passes-2321-2330.ts --migrate  # применить
 */
...
const LOG = '[delete-pool-2321-2330]';
