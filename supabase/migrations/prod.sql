...
-- Generated: 2026-02-21T09:54:13.727539
-- Database: postgres
...
-- Index on public.employees
CREATE UNIQUE INDEX idx_employees_sigur_id ON public.employees USING btree (organization_id, sigur_employee_id) WHERE (sigur_employee_id IS NOT NULL);
